...
@NgModule({
  declarations: [AccountsComponent, EstimatesComponent, EstimatesViewComponent, CreateEstimatesComponent, EditEstimateComponent, InvoicesComponent, InvoiceViewComponent, CreateInvoiceComponent, EditInvoiceComponent, PaymentsComponent, ExpensesComponent, ProvidentFundComponent, TaxesComponent, ExpensesTypeComponent, ExpensesListComponent],
  imports: [
    CommonModule,
