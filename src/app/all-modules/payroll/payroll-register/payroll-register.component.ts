...
@Component({
  ...
  styleUrls: ['./payroll-register.component.css']
})
  ...
  ngOnInit(): void {
        ...
        $(".get-pdf").click(function () {
          ...
          doc.autoTable(resA.columns, resA.data, {
                addPageContent: function(data) {
                  doc.setFontSize(14);
                  doc.text("Payroll Register", 350, 112);
                  doc.setFontSize(14);
    ...
    $(document).ready(function(){  
      $('.exceller').click(function () {
          ...
          link.download = "Payroll Register.xls";
    ...
    // $(document).ready(function() {
      ...
      //     $('.printClass').hide();
      //     $('.payslip-print2').click(function() {
      //       $('.printClass').window.print();
      //     });
      // });
      $(document).ready(function() {
        ...
        // DataTable initialisation
                ...
                var table = 	$('#datatable'); //hmm seems not needed! zz20180613_0723 just do NOT pass object into the datatable func. then you will NOT reinitiate, so it's okay. 
                // so I can reference later zz20180613_0720
