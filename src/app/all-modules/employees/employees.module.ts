...
@NgModule({
  declarations: [EmployeesComponent, AllEmployeesComponent, EmployeePageContentComponent, EmployeeListComponent, EmployeeProfileComponent, LeavesAdminComponent, LeaveSettingsComponent, AttendanceAdminComponent, AttendanceEmployeeComponent, GradeComponent, DesignationComponent, TimesheetComponent, OvertimeComponent, CategoryComponent, LeaveTypeComponent, LoanComponent, SupervisorComponent, DocumentsComponent, DocumentsTypeComponent, EmployeeGradeComponent, LoanTypeComponent, TimesheetAdminComponent, TimesheetEmployeeComponent, EmployeeSalaryComponent, DepartmentsComponent,LocationComponent,SiteComponent,AssetsComponent, CompanyComponent, SalaryMasterComponent],
  imports: [
    CommonModule,
    FormsModule,
    SharingModule,
